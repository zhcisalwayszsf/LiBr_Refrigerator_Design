...
namespace LiBr_Refrigerator_Design
{
    public partial class CondenserForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox_di.Text == string.Empty | textBox_d0.Text == string.Empty |
                    textBox_ri.Text == string.Empty | textBox_r0.Text == string.Empty |
                    textBox_condenser_q.Text == string.Empty | textBox_tk.Text == string.Empty |
                    textBox_tw1.Text == string.Empty | textBox_tw1.Text == string.Empty |
                    textBox_tube_length.Text == string.Empty | textBox_flu_qv.Text == string.Empty |
                    textBox_m.Text == string.Empty | textBox_h2o_r.Text == string.Empty | textBox_tube_lambda.Text == string.Empty)
            {
                NoInputMessage();
            }
            else
