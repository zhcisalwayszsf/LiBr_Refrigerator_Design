...
namespace LiBr_Refrigerator_Design
{
    ...
    public partial class GhForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox_di.Text == string.Empty |
                ...
                textBox_th.Text == string.Empty |
                textBox_t11.Text == string.Empty |
            ...
            else
            {
                ...
                double k, a, l, n, speed, a0, ai, k0, ki, d0, di, r0, ri, t11, t12, th, m, flu_qv, mixed_m, q_gh, tube_lambda, pho_g, pho_l, mu, water_lambda, cp;
                ...
                t11 = double.Parse(textBox_t11.Text);
                t12 = double.Parse(textBox_t12.Text);
                th = double.Parse(textBox_th.Text);
